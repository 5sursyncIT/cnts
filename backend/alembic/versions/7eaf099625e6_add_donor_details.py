...
def upgrade() -> None:
    ...
    op.drop_constraint(
        op.f("uq_actes_transfusionnels_poche_id"), "actes_transfusionnels", type_="unique"
    )
    op.drop_index(op.f("ix_actes_transfusionnels_poche_id"), table_name="actes_transfusionnels")
    op.create_index(
        op.f("ix_actes_transfusionnels_poche_id"),
        "actes_transfusionnels",
        ["poche_id"],
        unique=True,
    )
    ...
    op.drop_constraint(
        op.f("user_recovery_codes_user_id_fkey"), "user_recovery_codes", type_="foreignkey"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        op.f("user_recovery_codes_user_id_fkey"),
        "user_recovery_codes",
        "user_accounts",
        ["user_id"],
        ["id"],
    ...
    op.create_unique_constraint(
        op.f("uq_sync_devices_device_id"),
        "sync_devices",
        ["device_id"],
        postgresql_nulls_not_distinct=False,
    )
    ...
    op.create_index(
        op.f("ix_idempotency_scope_key"), "idempotency_keys", ["scope", "key"], unique=False
    )
    op.alter_column(
        "idempotency_keys",
        "created_at",
    ...
    op.create_unique_constraint(
        op.f("uq_hopitaux_nom"), "hopitaux", ["nom"], postgresql_nulls_not_distinct=False
    )
    op.alter_column(
        "hopitaux",
        "created_at",
    ...
    op.create_unique_constraint(
        op.f("uq_dons_din"), "dons", ["din"], postgresql_nulls_not_distinct=False
    )
    op.alter_column(
        "dons",
        "created_at",
    ...
    op.create_unique_constraint(
        op.f("uq_donneurs_cni_hash"), "donneurs", ["cni_hash"], postgresql_nulls_not_distinct=False
    )
    op.alter_column(
        "donneurs",
        "updated_at",
    ...
    op.create_unique_constraint(
        op.f("uq_cross_matches_poche_receveur"),
        "cross_matches",
        ["poche_id", "receveur_id"],
        postgresql_nulls_not_distinct=False,
    )
    op.alter_column(
        "cross_matches",
    ...
    op.create_unique_constraint(
        op.f("uq_actes_transfusionnels_poche_id"),
        "actes_transfusionnels",
        ["poche_id"],
        postgresql_nulls_not_distinct=False,
    )
