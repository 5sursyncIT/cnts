...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "transfert_id",
            UUID(as_uuid=True),
            sa.ForeignKey("transferts_inter_sites.id"),
            index=True,
            nullable=False,
        ),
        sa.Column(
            "poche_id", UUID(as_uuid=True), sa.ForeignKey("poches.id"), index=True, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "don_id", UUID(as_uuid=True), sa.ForeignKey("dons.id"), nullable=True, index=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "resultat", sa.String(16), index=True, nullable=False, server_default="EN_ATTENTE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column(
            "don_id", UUID(as_uuid=True), sa.ForeignKey("dons.id"), index=True, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "evolution", sa.String(16), index=True, nullable=False, server_default="EN_COURS"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            UUID(as_uuid=True),
            sa.ForeignKey("actes_transfusionnels.id"),
            index=True,
            nullable=False,
        ),
        sa.Column("moment", sa.String(16), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "evolution", sa.String(32), index=True, nullable=False, server_default="EN_COURS"
        ),
        sa.Column("declarant_id", UUID(as_uuid=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("nom", sa.String(200), nullable=False),
        sa.Column(
            "site_id", UUID(as_uuid=True), sa.ForeignKey("sites.id"), nullable=True, index=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "campagne_id",
            UUID(as_uuid=True),
            sa.ForeignKey("campagnes_collecte.id"),
            index=True,
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "non_conformite_id",
            UUID(as_uuid=True),
            sa.ForeignKey("non_conformites.id"),
            nullable=True,
            index=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "interface_id",
            UUID(as_uuid=True),
            sa.ForeignKey("interfaces_automates.id"),
            index=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "lot_id",
            UUID(as_uuid=True),
            sa.ForeignKey("lots_consommable.id"),
            index=True,
            nullable=False,
        ),
